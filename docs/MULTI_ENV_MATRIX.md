# SM-Data-Governance 多环境配置矩阵（MULTI-ENV MATRIX）
...
| 数据库名 | sm_data_governance_dev | sm_data_governance_staging | sm_data_governance |
| 域名 | sm-data-governance.dev.sm.example.com | sm-data-governance.staging.sm.example.com | sm-data-governance.sm.example.com |
